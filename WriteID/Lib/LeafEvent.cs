namespace WriteID.Lib
{
    ...
    public class LeafEvent
    {
        ...
        public delegate bool DataSendHandlerOfString(string data);
        ...
        public delegate bool Savedata(string ID, string SIGFOX_ID, string SIGFOX_PAC);
    }
}